{{-- resources/views/etablissement/personnels/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Nouvel employé - EduManager')

@php
    $pageTitle = 'Nouvel employé';
    $pageSub = 'Ajouter un membre du personnel';
@endphp
        ...
        <form action="{{ route('personnels.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid sm:grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <input type="date" name="date_embauche" value="{{ old('date_embauche') }}"
