{{-- resources/views/etablissement/semestres/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Nouveau semestre - EduManager')

@php
    $pageTitle = 'Nouveau semestre';
    $pageSub = 'Ajouter un semestre à un niveau';
@endphp
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        ...
        <form action="{{ route('semestres.store') }}" method="POST" class="space-y-4">
            @csrf
