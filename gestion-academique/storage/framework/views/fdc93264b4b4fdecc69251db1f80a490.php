    ...
    <div class="bg-white rounded-2xl p-5 card-hover border border-slate-100">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['etudiants'] ?? '2 547'); ?></p>
    ...
    <div class="bg-white rounded-2xl p-5 card-hover border border-slate-100">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['enseignants'] ?? '128'); ?></p>
                <p class="text-xs mt-2 text-green-600 font-semibold">
    ...
    <div class="bg-white rounded-2xl p-5 card-hover border border-slate-100">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['departements'] ?? '12'); ?></p>
    ...
    <div class="bg-white rounded-2xl p-5 card-hover border border-slate-100">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-slate-800 mt-2"><?php echo e($stats['taux_reussite'] ?? '87%'); ?></p>
                <p class="text-xs mt-2 text-green-600 font-semibold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projet_atelier_tp\gestion-academique\gestion-academique\resources\views/dashboard/index.blade.php ENDPATH**/ ?>